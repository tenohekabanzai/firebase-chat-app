...
const ChatFooter = () => {
  ...
  return (
    <div className='flex items-center bg-c1/[0.5] 
    p-2 rounded-xl relative'>
      {attachmentPreview && (<div className='absolute w-[100px] h-[100px] bottom-16 left-0 bg-c1 p-2 rounded-md'>
        ...
        bg-red-500 flex justify-center items-center absolute
      ...
      <div className='shrink-0 relative'>
        ...
        />
       { showEmojiPicker && (
        <ClickAwayListener onClickAway={()=>setShowEmojiPicker(!showEmojiPicker)}>
      ...
      {isTyping && (<div className='absolute -top-6 left-4 bg-c2
      w-full h-6'>
      ...
      {editMsg && (<div className='absolute -top-12 left-1/2
      -translate-x-1/2 bg-c4 flex items-center gap-2
      py-2 px-4 pr-2 rounded-full text-sm font-semibold
