...
const Message = ({message}) => {
        ...
        try {
            ...
            const updatedMessages = chatDoc.data().messages.map((message)=>{
                if(message.id === messageId){
                    ...
                    else if(action === DELETED_FOR_EVERYONE){
                        message.deletedInfo = {
  ...
  return (
    ...
    ${self ? "self-end":""}`}>
        ...
        <div className={`flex items-end gap-3 mb-1 first-letter
        ...
        />
            ...
            "rounded-bl-md bg-c1"}`}>
                ...
                <div className={`${showMenu ?"":"hidden"} group-hover:flex
                absolute top-2 ${self ?"left-2 bg-c5":"right-2 bg-c1"}`}
