...
import { signInWithPopup,sendPasswordResetEmail,signInWithEmailAndPassword,onAuthStateChanged,GoogleAuthProvider,FacebookAuthProvider } from "firebase/auth";
  ...
  const resetPassword = async()=>{
    try {
      toast.promise(async()=>{
        ...
        success: 'Reset Password send to ypur registered email id',
      ...
      <div className="flex items-center flex-col ">
        ...
        onSubmit={handleSubmit}>
          ...
          <div className="text-right w-full text-c3">
            ...
            onClick={resetPassword}>Forgot Password?</span>
          </div>
          <button
